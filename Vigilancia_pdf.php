...
$graph->img->SetMargin(20,10,10,20);
...
$vig_ec=$vis->grupo_enfcomunes_pdf($val,$vala,$valm,$enfcom);
...
if ($sum==0)
{
	...
	$pdf->gaficoPDF(array($vig_ge[1][1],$vig_ge[2][1],$vig_ge[3][1],$vig_ge[4][1],$vig_ge[5][1]),array($vig_ge[1][0],$vig_ge[2][0],$vig_ge[3][0],$vig_ge[4][0],$vig_ge[5][0]),'Grafico1',array(5,50,80,60),$nomgra1);
$sum=0;
...
if ($sum==0)
{
	...
	$pdf->gaficoPDF(array($vig_sx[2][1],$vig_sx[1][1]),array($vig_sx[2][0],$vig_sx[1][0]),'Grafico2',array(110,50,80,60),$nomgra2);
...
if ($sum==0)
{
	...
	$pdf->gaficoPDF(array($vig_gi[1][1],$vig_gi[2][1],$vig_gi[3][1],$vig_gi[4][1],$vig_gi[5][1],$vig_gi[6][1]),array($vig_gi[1][0],$vig_gi[2][0],$vig_gi[3][0],$vig_gi[4][0],$vig_gi[5][0],$vig_gi[6][0]),'Grafico3',array(5,110,80,60),$nomgra3);
$sum=0;
...
if ($sum==0)
{
	...
	$pdf->gaficoPDF(array($vig_mot[1][1],$vig_mot[2][1],$vig_mot[3][1],$vig_mot[4][1],$vig_mot[5][1],$vig_mot[6][1]),array($vig_mot[1][0],$vig_mot[2][0],$vig_mot[3][0],$vig_mot[4][0],$vig_mot[5][0],$vig_mot[6][0]),'Grafico5',array(110,110,80,60),$nomgra5);
/*
$sum=0;
