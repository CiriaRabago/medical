...
{	
$pdf->Image('cedula/'.$rowdv[27].'.JPG',70,20,100,80);
}	
if(file_exists('cedula/'.$rowdv[27].'.jpg'))
{	
$pdf->Image('cedula/'.$rowdv[27].'.jpg',70,20,100,80);
...
{
$pdf->Ln(50);				
$pdf->Image('carnet/'.$rowdv[27].'.JPG',70,130,120,120);
}
if(file_exists('carnet/'.$rowdv[27].'.jpg'))
{
$pdf->Ln(50);				
...
{	$pdf->Ln(40);
$pdf->Image('cedula/'.$benefe[0].'.JPG',20,38,80,60);
}
if(file_exists('cedula/'.$benefe[0].'.jpg'))
{	$pdf->Ln(40);
$pdf->Image('cedula/'.$benefe[0].'.jpg',20,38,80,60);
...
{
$pdf->Image('carnet/'.$benefe[0].'.JPG',110,38,80,65);
}	
if(file_exists('carnet/'.$benefe[0].'.jpg'))
{
$pdf->Image('carnet/'.$benefe[0].'.jpg',110,38,80,65);
...
{
$pdf->Ln();
$pdf->Image('acta/'.$rowdv[27].'.JPG',80,165,90,100);
}
if(file_exists('acta/'.$rowdv[27].'.jpg'))
{
$pdf->Ln();
