	...
	if($paci)
	{
	   ...
	   ?>
			...
			<tr class="titulorep">
			  ...
			  <td width="150">IMPRIMIR RESULTADOS</td>
			</tr>	   
...
<?php 	   $cont=0;
	   ...
	   ?>
			<tr class="texto" <?php  echo $color; ?>>
			  ...
			  <td width="200"><span onclick="irpdf(<?php  echo $row[0]; ?>,'orden_pdf.php');" style="cursor:hand; text-decoration:underline ">ORDEN</span></td>
			  <td width="200"><span onclick="irpdf(<?php  echo $row[0]; ?>,'resultado_exa.php');" style="cursor:hand; text-decoration:underline">RESULTADOS</span></td>
			</tr>	
           <?php  } ?>  
			<tr>
			  <td colspan="6"><div align="center">
				<img src="imagenes/p_salir1.gif" alt="salir al men&uacute; de an&aacute;lisis" 
				width="140" height="50" style="cursor:hand" onclick="top.mainFrame.location.href='lista_result.php'" 
...
<table width="436" border="0" align="center" >
    <tr class="titulofor">
      <td height="30" colspan="3"><div align="center" class="titulofor">Resultados por Paciente </div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" class="td-buttons"><div align="center">
      	<a href="#" onclick="validar();" class="button-add" alt="Agregar"  > <i class="fa fa-plus" aria-hidden="true"></i> Ingresar </a>
