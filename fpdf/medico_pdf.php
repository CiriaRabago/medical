...
//Cabecera de página
		function Header()
		{
			...
			$this->SetXY(10,25); 
			$this->MultiCell(0,10,'MEDICO',0,'C',false); 
			$this->SetFont('Arial','BI',10); 
			$this->Ln();  
...
//Creación del objeto de la clase heredada
  ...
  $pdf->SetXY(10,33);$pdf->MultiCell(0,6,'       CEDULA              NOMBRE                             ESPECIALIDAD TELEFONO 1   TELEFONO 2','TB','L',true);
  ...
  while ($row = mysql_fetch_row($result))
    {
	 ...
	 $pdf->SetXY(89,$pos);$pdf->MultiCell(0,6,$row[18],1,'L',false);
