...
<input name="ocu_ff" id="ocu_ff" type="hidden" value="" />
			...
			<tr>
			  <td colspan="5" class="td-btn"><div align="center">
				<a href="#" onclick="validar();" class="button-sort" alt="Buscar"  > <i class="fa fa-search" aria-hidden="true"></i> Buscar </a>
	...
	?> 
		  <table width="890">
		  	<tr class="titulofor">
			  <td width="890" colspan="10" align="center"><?php  echo $titulo; ?></td>
			</tr>	
			<tr class="titulorep">
			  <td width="20">N°</td>
			  ...
			  <td colspan="2" width="40">Accion</td>
			</tr>	   
...
<?php 		   while ($row=mysql_fetch_array($reg))
		   ...
		   ?>
				<tr class="texto" <?php  echo $color; ?>>
				  ...
				  <td width="20" align="center"><a href="visita_especifica.php?visi=<?php  echo $row[0]; ?>&ipaci=<?php  echo $row[1]; ?>&fecha=<?php  echo $row[5]; ?>&emp=<?php  echo $empresa; ?>&esta=<?php  echo $sta; ?>&motivo=<?php  echo $row[13]; ?>&cpaci=<?php  echo $row[2]; ?>&npaci=<?php  echo $row[3]; ?>" target="_blank"><img src="imagenes/search.gif" title="Ver" alt="Ver" border="0" /></a></td>
			  	  <td width="20" align="center"><a href="visita_modif.php?visi=<?php  echo $row[0]; ?>&idpac=<?php  echo $row[1]; ?>&npac=<?php  echo $row[3]; ?>&idemp=<?php  echo $row2[0]; ?>"><img src="imagenes/edit.gif" title="Modificar" alt="Modificar" border="0"/></a></td>
<!-- 			  	  <td width="20" align="center"><img src="imagenes/delete.gif" title="Inactivar" alt="Inactivar" border="0"/></td>
 -->				</tr>

	<?php 		}  ?>
				<tr >
				   <td colspan="12" align="center" class="td-btn">
          <a href="#" onclick="irpdf('listado_pac_pdf.php?fi=<?php  echo $_POST['ocu_fi'];?>&ff=<?php  echo $_POST['ocu_ff'];?>&serv=<?php  echo $_POST['servicio'];?>&ced=<?php  echo $_POST['cedula'];?>&sta=<?php  echo $_POST['estado'];?>&empr=<?php  echo $_POST['empresa'];?>')"  class="button-print" alt="Imprimir"   <?php  echo $ope5;?> > <i class="fa fa-print" aria-hidden="true"></i> Imprimir </a>
