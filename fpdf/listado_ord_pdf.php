           ...
           if($row[0]!=$orden)
		    {
			 ...
			 $pdf->Ln();		   
		      ...
		      {     
		       ...
		       $pdf->Cell(30,5,$row[7].'________',0,1,'L',false);
				  ...
				  while ($row2 = mysql_fetch_row($resulta))
		           {
					...
					if($xx>='4')
 		            ...
 		            $pdf->Cell(30,5,$row2[0].'________',0,0,'L',false);
           ...
           if($row[7]!=$perfil)
			...
			$perfil=$row[7];
			 ...
			 $pdf->Cell(10,5,'RESULTADO:',0,0,'L',false);
		      ...
		      {
		        $pdf->Line(10,$pdf->GetY(),272,$pdf->GetY());
		        $pdf->Cell(60,5,$row[6].'________',0,0,'L',false);		   
		        //$pdf->Cell(10,5,'________',0,0,'L',false);
			   }
			   else
			    {
           ...
           if($row[4]!=$perfil)
			...
			$perfil=$row[4];
			 ...
			 if($row[3]!='ORINA' && $row[3]!='HECES' && $row[3]!='HEMATOLOGIA COMPLETA')
		      ...
		      //  $pdf->Line(10,$pdf->GetY(),272,$pdf->GetY());
			    if($serv!='SEROLOGIA'){
		          $pdf->Cell(60,5,$row[3].'________',0,1,'L',false);		   
		         // $pdf->Cell(10,5,'________',0,1,'L',false);
				 }
				}
			   else
				  ...
				  while ($row2 = mysql_fetch_row($resulta))
		           {
					...
					if($xx>='4')
 		            ...
 		            $pdf->Cell(50,5,$row2[0].'________',0,0,'L',false);
					//$pdf->Cell(10,5,'________',0,0,'L',false);		   
