...
<?php 
		  ...
		  if ($gua<$datoscupo[3] )
		    {
			 ...
			 $ins=$cit->ins_cita();			
			 if($ins!=false) 
			   echo '<script>alert("Cita registrada con numero '.$ins.' para el '.$_POST["fechas"].'");</script>';
			 else
 ...
 ?>
  <table width="582" border="0" align="center">
    <tr class="titulofor">
      <td height="30" colspan="4"><div align="center" class="titulofor">Consulta Citas</div></td>
    </tr>
    <tr>
