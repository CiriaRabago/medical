		  ...
		  if ($gua<$datoscupo[3] )
		    {
			 ...
			 if($va==0)
			  {
			   $ins=$cit->ins_cita();	
			   $ms=$ins.";".$_POST['fechas'].";".$_POST['espe'].";".$_POST['medi'].";".$_POST['cedu'].";".$_POST['nom'];		
			   if($ins!=false) 
 ...
 ?>
  <table width="582" border="0" align="center">
	...
	<tr>
      ...
      <td colspan="3"><label>     
      <span class="texto Estilo2"><span class="Estilo3"><?php  echo $nom;?><input name="nom" type="hidden" value="<?php  echo $nom;?>"/> </span> </span> </label></td>
    </tr>
     <?php  } }?>
	<tr>
