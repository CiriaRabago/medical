...
<input name="aniohas" type="text" class="texto" id="aniohas" value="0" size="10" onkeypress='return soloNumeros(event)'/>
    ...
    <tr>
      ...
      <td width="207" class="td-btn">
      <a href="#" onclick="GuardarVR();" class="button-save" alt="Guardar"  > <i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar </a>

          <input name="ocu_g" id="ocu_g" type="hidden" value="0"/></td>

      <td width="169" class="td-btn">

      <a href="#" onclick="top.mainFrame.location.href='caract.php';" class="button-close" alt="Salir"  > <i class="fa fa-arrow-left" aria-hidden="true"></i> Volver </a>
</td>
    </tr>
  </table>
...
<table width="590" border="0" align="center">
    ...
    <tr>
      ...
      <td width="207">
      <a href="#" onclick="GuardarLV();" class="button-save" alt="Guardar"  > <i class="fa fa-floppy-o" aria-hidden="true"></i> Guardar </a>


          <input name="ocu_g2" id="ocu_g2" type="hidden" value="0"/></td>
      <td width="169">
         <a href="#" onclick="top.mainFrame.location.href='caract.php';" class="button-close" alt="Salir"  > <i class="fa fa-arrow-left" aria-hidden="true"></i> Volver </a>
</td>
    </tr>
