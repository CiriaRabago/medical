...
<input name="ocu_ff" id="ocu_ff" type="hidden" value="" />
	...
	?> 
        ...
        <input type="hidden" id="getf_in" value="<?php echo $_POST[ocu_fi]?>">
        <input type="hidden" id="getf_fi" value="<?php echo $_POST[ocu_ff]?>">
        <input type="hidden" id="getser" value="<?php echo $_POST[servicio]?>">
        <input type="hidden" id="getced" value="<?php echo $_POST[cedula]?>">
        <input type="hidden" id="getemp" value="<?php echo $_POST[empresa]?>">
        <input type="hidden" id="getmed" value="<?php echo $_POST[medico]?>">
