...
{
	$sql="select count(id_visita), nom_empresa  from slc_visita, slc_empresa where slc_visita.id_empresa='$e' and  slc_visita.id_empresa= slc_empresa.id_empresa and MONTH(fecha_ing_visita)='$m' and left(fecha_ing_visita,4)='$a' and status_visita='A' group by slc_visita.id_empresa";
	$result=mysql_query($sql,$this->conexion);
	$row = mysql_fetch_row($result);
		if ($result) 
		{	$visi= new visita('','','','','','','','','','','','','');
		   $HTML='<table width="660" border="0" align="center">
				...
				<tr>
				  <td class="etiqueta_grande">VIGILANCIA EPIDEMIOL&Oacute;GICA DEL MES DE '.$visi->nombre_mes($m).' DEL AÑO '.$a.'</td>
				</tr>
				<tr>
				  <td>&nbsp;</td>
				</tr>
...
function enfermedades_accidentes($e, $a, $m)
{
	$asis=0;
	$san=0;
	$enf=0;	
	...
	$sql="SELECT count(id_visita) FROM slc_visita, slc_diag_visita WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$i' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and slc_visita_id_visita=id_visita and tipo_diag_visita='Enfermedad Comun' and slc_diagnostico_id_diagnostico<>'' and status_visita='A'";
//echo $sql;
	$result=mysql_query($sql,$this->conexion);
	 $n=mysql_num_rows($result);
	 if($n>0)
	...
	$sql="SELECT count(id_visita) FROM slc_visita, slc_diag_visita WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$i' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and slc_visita_id_visita=id_visita and tipo_diag_visita='Enfermedad Laboral' and slc_diagnostico_id_diagnostico<>'' and status_visita='A'";
//echo $sql;
	$result=mysql_query($sql,$this->conexion);
	 $n=mysql_num_rows($result);
	 if($n>0)
	...
	/////////////////////
	//ACCIDENTES COMUNES/////////////
	$sql="SELECT count(id_visita) FROM slc_visita, slc_diag_visita WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$i' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and slc_visita_id_visita=id_visita and tipo_diag_visita='Accidente Comun' and slc_diagnostico_id_diagnostico<>'' and status_visita='A'";
//echo $sql;
	$result=mysql_query($sql,$this->conexion);
	 $n=mysql_num_rows($result);
	 if($n>0)
	...
	$sql="SELECT count(id_visita) FROM slc_visita, slc_diag_visita WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$i' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and slc_visita_id_visita=id_visita and tipo_diag_visita='Accidente Laboral' and slc_diagnostico_id_diagnostico<>'' and status_visita='A'";
//echo $sql;
	$result=mysql_query($sql,$this->conexion);
	 $n=mysql_num_rows($result);
	 if($n>0)
	...
	$enf=$enfm;
	$sql1="select count(id_visita) from slc_visita, slc_diag_visita  where id_empresa='$e' and MONTH(fecha_ing_visita)='$m' and left(fecha_ing_visita,4)='$a' and slc_paciente_id_paciente <>'' and status_visita='A' and slc_visita_id_visita=id_visita and (slc_diagnostico_id_diagnostico='1' or slc_diagnostico_id_diagnostico='2')";
	$result1=mysql_query($sql1,$this->conexion);
	...
	$sqla="select count(id_visita) from slc_visita  where id_empresa='$e' and MONTH(fecha_ing_visita)='$m' and left(fecha_ing_visita,4)='$a' and slc_paciente_id_paciente <>'' and status_visita='A'";
	...
	$sqlns="SELECT count(distinct id_visita) FROM slc_visita, slc_diag_visita WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and slc_visita_id_visita=id_visita and tipo_diag_visita='Enfermedad Comun' and slc_diagnostico_id_diagnostico<>'' and status_visita='A'";
	//echo $sqlns;
	...
	$HTML.='<tr><td colspan="5">&nbsp;</td></tr><tr><td colspan="5"><span aling="justify"><span class="texto">COMENTARIO: SE EVIDENCIA QUE EN EL MES DE </span><span class="textoN">'.$visi->nombre_mes($m).'</span> <span class="texto">ASISTIERON</span> <span class="textoN">'.$asis.'</span><span class="texto"> PACIENTE(S) DE LOS CUAL(ES)</span> <span class="textoN">'.$san.' </span><span class="texto">ESTÁN SANO(S) Y </span><span class="textoN">'.$enfc.' </span><span class="texto"> ENFERMEDAD(ES) COMUN(ES) EN </span><span class="textoN">'.$nosan.' </span><span class="texto"> TRABAJADORES, ES IMPORTANTE RESALTAR QUE LAS ENFERMEDADES COMUNES SE PUEDEN REPORTAR VARIAS EN UN MISMO PACIENTE.</span></span></td></tr><tr><td colspan="5">&nbsp;</td></tr><tr></table>';
	return $HTML.'**'.$enfc.'**'.$asis;


} 
	
function resultado_examenes($e,$a,$m)
{
	$sql="SELECT  fecha_ing_visita, motivo_consulta, conclusion_visita, slc_paciente_id_paciente FROM slc_visita WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and status_visita='A' ORDER BY fecha_ing_visita ASC ";
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	//echo $sql;
	if ($result) 
    ...
    $HTML.='<tr><td colspan="7">&nbsp;</td></tr><tr>
			  <td colspan="7"><div align="justify"><span class="texto">EL COMIT&Eacute; DE HIGIENE Y SEGURIDAD DE LA EMPRESA DEBE REALIZAR SEGUIMIENTO DE LOS</span> <span class="textoN">NO APTOS</span> <span class="texto">Y </span><span class="textoN">APTOS CON LIMITACI&Oacute;N</span>, <span class="texto">DE MANERA DE DISMINUIR LAS ENFERMEDADES COMUNES Y OCUPACIONALES. </span></div></td>
...
function referencias_visitas($e,$a,$m)
{
		 $HTML.='<table width="660" border="0" align="center">
    <tr class="etiqueta_grande">
	...
	$sql="SELECT fecha_ing_visita, motivo_consulta, nomb_esp, slc_paciente_id_paciente,id_visita FROM slc_visita, slc_ref_visita, slc_especialidad WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and slc_visita_id_visita=id_visita and id_esp_ref=id_esp and status_visita='A' ORDER BY fecha_ing_visita ASC";
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	if ($n>0) 
	{ 
    ...
    $HTML.='<tr><td colspan="7">&nbsp;</td></tr><tr>
			  <td colspan="7"><div align="justify"><span class="texto">EL COMIT&Eacute; DE HIGIENE Y SEGURIDAD DE LA EMPRESA DEBE REALIZAR SEGUIMIENTO DE LAS REFERENCIAS MÉDICAS PARA ASEGURAR QUE SEAN CUMPLIDAS. </span></div></td>
...
function reposos_visitas($e,$a,$m)
{
	...
	$sql="SELECT  fecha_ing_visita, motivo_consulta, repos_visita, slc_paciente_id_paciente FROM slc_visita WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and repos_visita!=''  and status_visita='A' ORDER BY fecha_ing_visita ASC ";
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	if ($n>0) 
	{ 
...
{ 
	$sql="SELECT slc_paciente_id_paciente, CASE WHEN (MONTH( fecha_nac_pac ) < MONTH( current_date )) THEN YEAR( current_date ) - YEAR( fecha_nac_pac ) 
		WHEN (MONTH( fecha_nac_pac ) = MONTH( current_date )) AND (DAY( fecha_nac_pac ) <= DAY( current_date ))
			...
			AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and status_visita='A' ORDER BY fecha_ing_visita ASC ";
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	if ($n>0) 
	{ 
	...
	$HTML.='<table width="660" border="0" align="center">
    <tr class="etiqueta_grande">
      <td colspan="3"><div align="center">TABLA CARACTERISTICAS GENERALES '.$m.'-'.$a.'</div></td>
    </tr>
    <tr class="titulofor">
...
{
	$sql="select count(sexo_paciente), sexo_paciente from slc_visita, slc_paciente where id_empresa = '$e'
AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' 
and (slc_paciente_id_paciente=id_paciente or slc_paciente_id_paciente=ced_paciente)  and status_visita='A' group by sexo_paciente
";
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	if ($n>0) 
...
AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' 
and (slc_paciente_id_paciente=id_paciente or slc_paciente_id_paciente=ced_paciente) and status_visita='A' group by grado_inst_pac";
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	if ($n>0) 
	{ 
...
function grupo_enfcomunes($e,$a,$m,$tp)
{
	...
	$sql="SELECT count(slc_diagnostico_id_diagnostico), nomb_diagnostico FROM slc_visita, slc_diag_visita, slc_diagnostico WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and slc_visita_id_visita=id_visita and tipo_diag_visita='Enfermedad Comun' and slc_diagnostico_id_diagnostico<>'' and status_visita='A' and id_diagnostico=slc_diagnostico_id_diagnostico group by slc_diagnostico_id_diagnostico";
//echo $sql;
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	if ($n>0) 
...
function grupo_motivo($e,$a,$m,$tp)
{
	...
	$sql="select count(motivo_consulta ), motivo_consulta from slc_visita where id_empresa = '$e'
AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and status_visita='A' 
...
function grupo_result($e,$a,$m,$tp)
{
	...
	$sql="select count(conclusion_visita), conclusion_visita from slc_visita where id_empresa = '$e'
AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and status_visita='A'
...
function patologias($e,$a,$m,$tp,$ec)
{
    ...
    <tr>';
	$sql="SELECT count(slc_diagnostico_id_diagnostico) FROM slc_visita, slc_diag_visita WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and slc_visita_id_visita=id_visita and tipo_diag_visita='Enfermedad Laboral' and slc_diagnostico_id_diagnostico<>'' and status_visita='A'";
	//echo $sql;
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	if ($n>0) 
...
function relacion_enf_dis($e,$a,$m,$tp)
{
	$HTML.='<table width="660" border="0" align="center">
    ...
    <tr>';
	$sql="select slc_paciente_id_paciente, nomb_diagnostico, conclusion_visita from slc_visita,slc_diag_visita, slc_diagnostico where id_empresa = '$e'
AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' and status_visita='A' and conclusion_visita='Apto con Limitación' and slc_visita_id_visita=id_visita and slc_diagnostico_id_diagnostico<>'' and id_diagnostico=slc_diagnostico_id_diagnostico";
	//echo $sql;
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	if ($n>0) 
	...
	<tr><td colspan="3"><span aling="justify"><span class="texto">PATOLOGÍAS AMERITAN SER INVESTIGADAS Y NOTIFICADAS AL </span><span class="textoN">CONSEJO NACIONAL PARA PERSONAS CON DISCAPACIDAD.</span></span></td></tr><tr><td colspan="4">&nbsp;</td></tr></table>';
	return $HTML;
}
///////////////////////VIGILANCIA///////////////////////
...
function inf_empresa_pdf($e,$a,$m)
{
	...
	and  slc_visita.id_empresa= slc_empresa.id_empresa and MONTH(fecha_ing_visita)='$m' 
	and left(fecha_ing_visita,4)='$a' and status_visita='A' group by slc_visita.id_empresa";
	$result=mysql_query($sql,$this->conexion);
	$row = mysql_fetch_row($result);
		if ($result) 
		{	
...
function enfermedades_accidentes_pdf($e, $a, $m)
{
	...
	{	//ENFERMEDADES COMUNES
		$sql="SELECT count(id_visita) 
			...
			AND MONTH( fecha_ing_visita ) = '$i' AND left( fecha_ing_visita, 4 ) = '$a' 
	...
	where id_empresa='$e' and MONTH(fecha_ing_visita)='$m' and left(fecha_ing_visita,4)='$a' 
	and slc_paciente_id_paciente <>'' and status_visita='A' and slc_visita_id_visita=id_visita 
	and (slc_diagnostico_id_diagnostico='1' or slc_diagnostico_id_diagnostico='2')";
	$result1=mysql_query($sql1,$this->conexion);
	$row1 = mysql_fetch_row($result1);
	if ($result1)
	{
	...
	and MONTH(fecha_ing_visita)='$m' and left(fecha_ing_visita,4)='$a' 
...
function resultado_examenes_pdf($e,$a,$m)
{
	$sql="SELECT  fecha_ing_visita, motivo_consulta, conclusion_visita, slc_paciente_id_paciente 
		FROM slc_visita WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$m' 
		AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' 
		and status_visita='A' ORDER BY fecha_ing_visita ASC ";
	$result=mysql_query($sql,$this->conexion);
	$n=mysql_num_rows($result);
	if ($result) 
	{ 
...
function referencias_visitas_pdf($e,$a,$m)
{
	...
	$sql="SELECT fecha_ing_visita, motivo_consulta, nomb_esp, slc_paciente_id_paciente,id_visita 
		 ...
		 WHERE id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$m' 
		 AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' 
		 and slc_visita_id_visita=id_visita and id_esp_ref=id_esp and status_visita='A' 
...
function grupo_sexo_pdf($e,$a,$m,$tp)
{
	...
	where id_empresa = '$e' AND MONTH( fecha_ing_visita ) = '$m' 
	AND left( fecha_ing_visita, 4 ) = '$a' and slc_paciente_id_paciente <>'' 
	and (slc_paciente_id_paciente=id_paciente or slc_paciente_id_paciente=ced_paciente)  
	and status_visita='A' 
...
function relacion_enf_dis_pdf($e,$a,$m,$tp)
{
	...
	//$sql="select slc_paciente_id_paciente, conclusion_visita 
		//from slc_visita where id_empresa = '$e'
		//AND MONTH( fecha_ing_visita ) = '$m' AND left( fecha_ing_visita, 4 ) = '$a' 
		//and slc_paciente_id_paciente <>'' and status_visita='A' 
		//and conclusion_visita='Apto con Limitación'";
			$sql="select slc_paciente_id_paciente, nomb_diagnostico, conclusion_visita 
