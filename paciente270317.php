...
$_POST["ususis"]=$_SESSION["cedu_usu"];
 ...
 if(isset($_POST["ocu_g"]) && $_POST["ocu_g"]!='0' )
  { 
  	...
  	$ben= new benef($_POST["ced"],$_POST["ced"],$_POST["nom1"].$fecha_ac.$_POST["ape1"],$fecha_ac,$_SESSION["cedu_usu"],$_POST["te1"]); 
	...
	if($_POST["cheq_titular"]==2 ){//consulta o inserta titular
      $ben= new benef($_POST["cedtit"],$_POST["ced"],$_POST["nomtit"],$fecha_ac,$_SESSION["cedu_usu"],$_POST["teltit"]); 
       $regb=$ben->cons_benef3($_POST["ced"]);
       if($regb!=false)
	   { 
...
* d&iacute;a/mes/a&ntilde;o Ejemplo: 04/06/1998</strong></span>
    ...
    <tr>
	  ...
	  <span class="Estilo2"  >El paciente es el titular de la p&oacute;liza</span>
	   ...
	   ?>
			<tr>
			<td colspan="4"><div id="contenido" style="display: none">
			...
			<input type="text" class="texto" name="teltit" id="teltit" value="<?phpecho $benefe[3];?>"/></div></td>
			</tr>
	   <?php 
